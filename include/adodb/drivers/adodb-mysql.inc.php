...
if (! defined("_ADODB_MYSQL_LAYER")) {
 ...
 if (!defined('MYSQL_DIR')) define('MYSQL_DIR',dirname(dirname(dirname(dirname(__FILE__)))));
 require_once MYSQL_DIR.'/classes/mysql.class.php';
...
//		return "from_unixtime(unix_timestamp($date)+$fraction)";
	...
	function _connect($argHostname, $argUsername, $argPassword, $argDatabasename)
	{
		...
		if (ADODB_PHPVER >= 0x4300){
		    ...
		    $this->_connectionID = mysql::getLink($fun, $argHostname, $argUsername, $argPassword,$this->forceNewConnect,$this->clientFlags);
		}else if (ADODB_PHPVER >= 0x4200){
			//$this->_connectionID = mysql_connect($argHostname,$argUsername,$argPassword,
			//									$this->forceNewConnect);
		    $this->_connectionID = mysql::getLink($fun, $argHostname, $argUsername, $argPassword,$this->forceNewConnect);
		}else{
			//$this->_connectionID = mysql_connect($argHostname,$argUsername,$argPassword);
			$this->_connectionID = mysql::getLink($fun, $argHostname, $argUsername, $argPassword);
		}
	...
	function _pconnect($argHostname, $argUsername, $argPassword, $argDatabasename)
	{
		...
		if (ADODB_PHPVER >= 0x4300){
		    ...
		    $this->_connectionID = mysql::getLink($fun, $argHostname, $argUsername, $argPassword,$this->clientFlags);
		}else{
