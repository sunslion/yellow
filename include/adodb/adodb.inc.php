 ...
 */
 ...
 if (!defined('_ADODB_LAYER')) {
	...
	*/
	...
	//echo defined("_ADODB_CACHE_DIR");	
	$ADODB_CACHE_DIR = '/mnt/www/cache'; //  Cache Dir office.frontend@gmail.com
...
*/
	...
	var $memCacheHost = '127.0.0.1'; /// memCache host
...
//var_dump(function_exists('_rs2serialize'));exit;
			if ($rs) {

				$eof = $rs->EOF;
				$rs = $this->_rs2rs($rs); // read entire recordset into memory immediately
				$rs->timeCreated = time(); // used by caching
				if (!function_exists(_rs2serialize)) {
