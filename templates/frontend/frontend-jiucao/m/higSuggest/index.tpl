<link rel="stylesheet" href="/templates/frontend/frontend-jiucao/m/higSuggest/css/normalize.css">
<link rel="stylesheet" href="/templates/frontend/frontend-jiucao/m/higSuggest/css/reset.css">
<!--轮播图插件-->
<link rel="stylesheet" href="/templates/frontend/frontend-jiucao/m/higSuggest/css/owl.carousel.css">
<link rel="stylesheet" href="/templates/frontend/frontend-jiucao/m/higSuggest/css/owl.theme.css">
<!--自定义css-->
<link rel="stylesheet" href="/templates/frontend/frontend-jiucao/m/higSuggest/css/style.css"/>
<!--极品推荐-->
<div class="ad-recommend">
    <div class="ad-reco-head">
        <h3>极品推荐</h3>
    </div>
    <div id="owl-demo">
